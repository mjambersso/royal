...
function be2() {				
	...
	if(NRooms == 1){        
		...
		var searchParameters = "?q=" + property + "&lang=" + 'fr-FR' + "&CheckIn=" + CheckIn + "&CheckOut=" + CheckOut + "&NRooms=" + NRooms + "&ad=" + nr_adults + "&ch=" + nr_childs + "&ag=" + childAges + "&Code=" + promoCode + "";		
	}
	...
	if(NRooms > 1){
		...
		// search parammeters
		var searchParameters = "?q=" + property + "&lang=" + 'fr-FR' + "&CheckIn=" + CheckIn + "&CheckOut=" + CheckOut + "&NRooms=" + NRooms + "&ad=" + strRAdults + "&ch=" + strChilds + "&ag=" + strRChildsAges + "&Code=" + promoCode + "";		
