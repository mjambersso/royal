...
function be2() {				
	...
	if(NRooms == 1){        
		...
		var searchParameters = "?q=" + property + "&lang=" + 'es-ES' + "&CheckIn=" + CheckIn + "&CheckOut=" + CheckOut + "&NRooms=" + NRooms + "&ad=" + nr_adults + "&ch=" + nr_childs + "&ag=" + childAges + "&Code=" + promoCode + "";		
	}
	...
	if(NRooms > 1){
		...
		// search parammeters
		var searchParameters = "?q=" + property + "&lang=" + 'es-ES' + "&CheckIn=" + CheckIn + "&CheckOut=" + CheckOut + "&NRooms=" + NRooms + "&ad=" + strRAdults + "&ch=" + strChilds + "&ag=" + strRChildsAges + "&Code=" + promoCode + "";		
...
if (ua.indexOf('safari')!=-1){
  if(ua.indexOf('chrome')  > -1){
    /* chrome */
    $(function(){
        $('.row_1 .col_2 a, .row_2 .col_2 a').css('top','5px');
        $('.row_3 .col_4 input').css('top','2px');
    });    
  }
  else{
    /* safari */
    $(function(){
        $('.row_1 .col_2 a, .row_2 .col_2 a').css('top','5px');
        $('.row_3 .col_4 input').css('top','2px');
        $('.row_3 .col_4 input').css('padding','3px 1px');
    }); 
   }
} 
else {
